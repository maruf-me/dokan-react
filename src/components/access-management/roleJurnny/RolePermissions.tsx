...
import { LeftSection } from '@/components/access-management/roleJurnny/LeftSection';
import { RightSection } from '@/components/access-management/roleJurnny/RightSection';
